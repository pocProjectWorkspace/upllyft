      ...
      <div className="space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {worksheets.map((ws) => (
              <Card key={ws.id} className="overflow-hidden card-hover group">
                {/* Preview image */}
                <div
                  className="aspect-[4/3] bg-gradient-to-br from-teal-50 to-teal-100 flex items-center justify-center cursor-pointer relative"
                ...
                <div className="p-4 space-y-3">
                  <h3
                    className="font-semibold text-gray-900 line-clamp-1 cursor-pointer group-hover:text-teal-700"
                    onClick={() => router.push(`/${ws.id}`)}
                  >
                    {ws.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="flex items-center gap-1">
                      ...
                      <span className="text-gray-700 font-medium">{ws.averageRating.toFixed(1)}</span>
