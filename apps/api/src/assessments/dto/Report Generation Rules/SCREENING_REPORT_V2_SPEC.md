...
```json
{
  ...
  "disclaimers": [
    "This report was generated using Upllyft Developmental Screening, a multi-domain screening tool adapted from the WHO/UNICEF Nurturing Care Framework, ASQ-3, WHO ICF, and CDC developmental milestones. It is NOT a medical or psychological diagnosis.",
