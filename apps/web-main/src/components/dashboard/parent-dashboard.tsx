    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <a
            href="/moments"
            className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-amber-300 group transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_12px_24px_-8px_rgba(245,158,11,0.2)] relative"
          >
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 bg-gradient-to-br from-amber-400 to-amber-600">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.196-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.783-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
              </svg>
            </div>
            <h3 className="font-semibold text-gray-900 mb-1 group-hover:text-amber-700">Everyday Moments</h3>
            <p className="text-sm text-gray-500">
              {selectedChild ? `Capture a small moment about ${selectedChild.firstName}` : 'Capture the small moments that matter'}
            </p>
          </a>
